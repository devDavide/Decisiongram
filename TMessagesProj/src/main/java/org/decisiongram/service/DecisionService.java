...
public interface DecisionService {
     ...
     * @param messageObject
     * @param url
     * @return a Bundle for invoking VoteMangerFragment, based on decisiongram message
     * @throws DecisionDAOException in case of not found decision. The message can be showed to
    ...
    Bundle getBundleForVotesManagerFragment(TLRPC.ChatFull info, MessageObject messageObject,
                                            final ClickableSpan url) throws DecisionDAOException;
